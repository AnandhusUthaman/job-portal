...
const ApplyJob = () => {
  ...
  useEffect(() => {
    if(jobs.length > 0){  //check if jobs is loaded
      fetchJob();
    }
  }, [id,jobs]);
      ...
      <div className='bg-white text-black rounded-lg w-full'>
        <div className='flex justify-center md:justify-between flex-warp gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
          ...
          <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
            <button className='bg-blue-600 text-white px-10 p-2.5 rounded-md'>Apply Now</button>
         ...
         <div className='flex flex-col lg:flex-row justify-between items-start'>
            <div className='w-full lg:w-2/3'>
              ...
              <div className='rich-text' dangerouslySetInnerHTML={{__html: JobData.description}}></div>
                <button className='bg-blue-600 text-white px-10 p-2.5 rounded-md mt-10'>Apply Now</button>
              </div>
